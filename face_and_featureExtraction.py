...
src_path = "/Users/myazdaniUCSD/Documents/selfiecity_v1/images/selfies/thumb/"
...
image_paths_list = list(chunks(image_paths_list, len(image_paths_list)/4))
...
for i, image_paths in enumerate(image_paths_list):
  ...
  results= Parallel(n_jobs=4)(delayed(return_face_dict)(image_path) for image_path in image_paths)
